...
2.  State状态，关联快照，组合成 SnapshotState，快照有 2 个作用
...
2. 所有的控件最终都会调用到 Layout 方法，指定MeasurePolicy和Modifier
3. 在 Android 系统中，通过 AndroidComposeView下发测量布局和绘制请求；
4. LayoutNode.insertAt
# 参考链接

...
SlotTable 中存在 2 个数组，groups和 slots;
1. groups 是一个 IntArray，每 5 个 Int 为一组构成一个 Group 的信息
	1. key : Group 在 SlotTable 中的标识，在 Parent Group 范围内唯一
